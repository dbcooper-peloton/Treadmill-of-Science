...
// developer note: example C to C# struct for other projects
/*
...
namespace xsensor
{
    ...
    public class XSCore90
    {
        ...
        public static extern XSErrorCodes XS_GetLastErrorCode();
        ...
        [DllImport("XSCore90", CallingConvention = CallingConvention.Cdecl)]
        public static extern void XS_SetAllowEnumInterruptX4Remote(xbool allow);
        [DllImport("XSCore90", CallingConvention = CallingConvention.Cdecl)]
        public static extern xbool XS_GetAllowEnumInterruptX4Remote();
        ...
        [DllImport("XSCore90", CallingConvention = CallingConvention.Cdecl)]
        public static extern xbool X4_OpenRemote(SENSORPID spid);
        ...
        [DllImport("XSCore90", CallingConvention = CallingConvention.Cdecl)]
        public static extern xbool X4_CloseRemote(SENSORPID spid);
        // Closes a remote connection to an X4 sensor.

        [DllImport("XSCore90", CallingConvention = CallingConvention.Cdecl)]
        public static extern xbool X4_IsRemoteRecording(SENSORPID spid, ref xbool remoteRecording);
        // Is the X4 currently recording remotely?
        // Sets remoteRecording to xTRUE if it is.

        [DllImport("XSCore90", CallingConvention = CallingConvention.Cdecl)]
        public static extern xbool X4_StartRemoteRecording(SENSORPID spid, float framesPerSecond);
        // Starts the X4's remote recording.

        [DllImport("XSCore90", CallingConvention = CallingConvention.Cdecl)]
        public static extern xbool X4_StopRemoteRecording(SENSORPID spid);
        // Stops the X4's remote recording. This ends the active session.

        [DllImport("XSCore90", CallingConvention = CallingConvention.Cdecl)]
         public static extern xbool X4_StartRemotePairRecording(SENSORPID spid_left_insole, SENSORPID spid_right_insole, float framesPerSecond);
        // Starts a synchronized recording for two X4 foot sensors (left and right insoles only)

        [DllImport("XSCore90", CallingConvention = CallingConvention.Cdecl)]
         public static extern xbool X4_StopRemotePairRecording(SENSORPID spid_left_insole, SENSORPID spid_right_insole);
        // Stops a synchronized recording

        [DllImport("XSCore90", CallingConvention = CallingConvention.Cdecl)]
         public static extern xbool X4_SampleRemote(SENSORPID spid);
        ...
        [DllImport("XSCore90", CallingConvention = CallingConvention.Cdecl)]
         public static extern xbool X4_GetRemoteSampleRange(SENSORPID spid, EPressureUnit pressureUnits, ref float minPressure, ref float maxPressure);
        // Fetch the pressure range of the remote sample.
        // Only valid after at least one successful call to X4_SampleRemote()

        [DllImport("XSCore90", CallingConvention = CallingConvention.Cdecl)]
         public static extern xbool X4_GetRemoteDuration(SENSORPID spid, float framesPerSecond, ref uint minutes);
