...
shutil.move(r"C:\TOS_Data\Accels\accel_and_current_data.tdms",Destination + r"\accel_and_power_data.tdms")
shutil.move(r"C:\TOS_Data\Accels\accel_and_current_data.tdms_index",Destination + r"\accel_and_power_data.tdms_index")
...
shutil.move(r"C:\TOS_Data\Torque\Torque_Data.tdms", Destination + "\Torque_Data.tdms")
shutil.move(r"C:\TOS_Data\Torque\Torque_Data.tdms_index",Destination + "\Torque_Data.tdms_index")
